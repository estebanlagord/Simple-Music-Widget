...
public class MusicLoader {
    ...
    private final AlbumArtLoader albumArtLoader;
    private Cursor cur;
    private boolean isShuffleOn;
    private AtomicBoolean isPrepared = new AtomicBoolean(false);

    public MusicLoader(Context context, AlbumArtLoader albumArtLoader) {
    ...
    public Song getCurrent() {
        ...
        Song song = new Song(id, title, artist, duration, albumId);
