    ...
    private void updateUI(Song song, Boolean isPlaying) {
        ...
        if (song != null) {
            if (mNotification == null) {
                mNotification = new MusicNotification(this, ONGOING_NOTIFICATION_ID,
                        song, isShuffleOn, mediaSession.getSessionToken(), getChannelId());
                ...
                mNotification.update(song, isPlayingUnboxed, isShuffleOn, mediaSession.getSessionToken());
            }
        } else {
            stopForeground(true);
        }
